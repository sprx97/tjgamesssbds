...
void FinalDestination::Initialize() {
	...
	walls.push_back(Wall(96, 132, 116, 0, "left"));
	walls.push_back(Wall(416, 132, 116, 0, "right"));
	walls.push_back(Wall(65, 132, 1, 0, "left"));
	walls.push_back(Wall(447, 132, 1, 0, "right"));
...
void PokemonStadium::Initialize() {
	...
	walls.push_back(Wall(43, 154, 102, 0, "left"));
	walls.push_back(Wall(469, 154, 102, 0, "right"));
...
void CastleSiege::Initialize() {
	...
	walls.push_back(Wall(41, 216, 40, 0, "left"));
	walls.push_back(Wall(449, 191, 40, 0, "right"));
	ceilings.push_back(Ceiling(40, 256, 100));
	ceilings.push_back(Ceiling(349, 231, 100));
	walls.push_back(Wall(55, 256, 200, 0, "left"));
	walls.push_back(Wall(435, 231, 200, 0, "right"));
